...
SLIDER_CONFIGS = [
    ...
    {
    "label": "Accélération du vaccin",
    "from_": 0.0,
    "to": 0.2,
    "default": 0.01,
    "row": 6,
    "attr": "vaccination_acceleration_slider",
},
]
...
STRATEGY_CONFIGS = [
    {
        "label": "Stratégie 1 : Quarantaine dynamique (infectés)",
        "attr": "strategy_1_active",
        "row": 7,
    },
    {
        "label": "Stratégie 2 : Quarantaine des contacts proches",
        "attr": "strategy_2_active",
        "row": 8,
    },
]
